...
#define CONF_USB_COMPOSITE_IMANUFACT_STR "Connections Museum"
#endif

#ifndef CONF_USB_COMPOSITE_IMANUFACT_STR_DESC
#define CONF_USB_COMPOSITE_IMANUFACT_STR_DESC                                                                          \
	38, 0x03, 'C', 0x00, 'o', 0x00, 'n', 0x00, 'n', 0x00, 'e', 0x00, 'c', 0x00, 't', 0x00, 'i', 0x00, 'o', 0x00, 'n',  \
	    0x00, 's', 0x00, ' ', 0x00, 'M', 0x00, 'u', 0x00, 's', 0x00, 'e', 0x00, 'u', 0x00, 'm', 0x00,
#endif
...
#define CONF_USB_COMPOSITE_IPRODUCT_STR "3ESS Tape Emulator"
#endif

#ifndef CONF_USB_COMPOSITE_IPRODUCT_STR_DESC
#define CONF_USB_COMPOSITE_IPRODUCT_STR_DESC                                                                           \
	38, 0x03, '3', 0x00, 'E', 0x00, 'S', 0x00, 'S', 0x00, ' ', 0x00, 'T', 0x00, 'a', 0x00, 'p', 0x00, 'e', 0x00, ' ',  \
	    0x00, 'E', 0x00, 'm', 0x00, 'u', 0x00, 'l', 0x00, 'a', 0x00, 't', 0x00, 'o', 0x00, 'r', 0x00,
#endif
